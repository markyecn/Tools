...
- (void)setUpInit {
    ...
    VENCalculatorInputView *inputView = [VENCalculatorInputView sharedInputView];
...
-(void)calculatorInputViewDidTapHideBtn:(VENCalculatorInputView *)calculatorInputView{
    [self endEditing:YES];
}

-(void)calculatorInputViewDidTapConfirmBtn:(VENCalculatorInputView *)calculatorInputView{
    [self endEditing:YES];
}
